-- Se podria decir que los ctes son como unas consultas o tablas en memoria y a esa consulta o tabla en memoria se le pueden aplicar otras consultas.
...
SELECT 
	*
FROM 
	posts_week_2024 AS pw
WHERE 
	pw.weeks BETWEEN '2024-01-01' AND '2024-12-31'
	AND 
	pw.total_claps >= 600 ;